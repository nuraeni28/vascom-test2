...
<div class="page-content-wrapper mt-10">
    ...
    <tr>
        ...
        <td>
            <form id="verificationForm" method="POST" action="{{ route('admin.user.verify', $data->id) }}" class="m-1">
                @csrf
                @method('PATCH')
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.user.edit',$data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="nama">Nama</label>
                                    <input type="text" name="nama" class="form-control" value="{{ $data->name }}" placeholder="Masukkan Nama">
                                </div>
                                <div class="form-group">
                                   <label for="no">No Telepon</label>
                                   <input type="text" name="no_telp" class="form-control" value="{{ $data->no_hp }}"  placeholder="Masukkan No Telepon">
                               </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="text" name="email" class="form-control" value="{{ $data->email }}" placeholder="Masukkan Email">
                                </div>
                                <div class="form-group">
                                    <label for="matkul">Foto</label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda Ingin menghapus User {{ $data->name }}?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <form id="deleteForm" method="POST" action="{{ route('admin.user.delete', $data->id) }}">
                    @csrf
                    @method('DELETE')                
