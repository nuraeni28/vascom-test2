...
<html>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
      ...
      <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.html">
            <img src="assets/home/images/main-logo.png" class="logo">
          </a>
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body">
              <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                    @guest
                        <a class="nav-link me-4 active" href="{{ route('login') }}">Login</a>
                    @else
                    @auth
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ Auth::user()->name }}
                            <img src="/Foto/{{ auth()->user()->foto }}" alt="Profile Image" width="30" height="30">
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li>
                                <a href="{{ route('logoutUser') }}" style="text-align: center; display: block; width: 100%;">
                                    Logout
                                </a>
                            </li>
                        </ul>
              ...
              <div class="row d-flex align-items-center">
                ...
                <div class="col-md-5">
                  <div class="image-holder">
                    <img src="assets/home/images/banner-image.png" alt="banner">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="swiper product-swiper">
            <div class="swiper-wrapper">
                @foreach ($pdAk as $item)
                    
               
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/Foto/{{ $item->foto }}" alt="product-item" class="img-fluid">
                  </div>
                  ...
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    ...
                    <span class="item-price text-primary">Rp {{ number_format($item->harga, 0, ',', '.') }}</span>
    ...
    <script type="text/javascript" src="assets/home/js/bootstrap.bundle.min.js"></script>
    <script type="text/javascript" src="assets/home/js/plugins.js"></script>
